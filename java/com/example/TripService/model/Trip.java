...
import com.example.TripService.service.TripStatus;
...
public abstract class Trip {
    ...
    public Trip(int tripId, int userId, TripStatus tripStatus, String pickupLocation, String destination, Date date) {
        this.tripId = tripId;
        this.userId = userId;
